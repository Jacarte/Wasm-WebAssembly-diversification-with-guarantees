...
A budget-based loop then initiates, as marked by lines 8 and 9, aiming to apply a series of code transformations.
...
The algorithm then returns the generated variant, which guarantees that both diversified machine code and traces are different from the original.

\todo{Test based validation. The runtime will capture a lot of ill formed variants. 1- Static verification, 2- Rewriting rules, 3- Execution if possible. Emphasize more the validation steps. }
